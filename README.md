# pandoc-beamer-block
[![Build Status](https://img.shields.io/travis/chdemko/pandoc-beamer-block/0.1.2.svg?logo=travis)](https://travis-ci.org/chdemko/pandoc-beamer-block/branches)
[![Coveralls](https://img.shields.io/coveralls/github/chdemko/pandoc-beamer-block/0.1.2.svg?logo=Codecov&logoColor=white)](https://coveralls.io/github/chdemko/pandoc-beamer-block?branch=0.1.2)
...
See the [Read the docs pages](http://pandoc-beamer-block.readthedocs.io/en/0.1.2/).
